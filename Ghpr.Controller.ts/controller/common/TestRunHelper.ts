...
class TestRunHelper {
    ...
    static getColor(t: TestRun): string {
        const result = this.getResult(t);
        return this.getColorByResult(result);
    }

    static getResult(t: TestRun): TestResult {
    ...
    static getColoredResult(t: TestRun): string {
    ...
    static getOutput(t: TestRun): string {
        return t.output === "" ? "-" : t.output;
    }

    static getMessage(t: TestRun): string {
        return t.testMessage === "" ? "-" : t.testMessage;
    }

    static getDescription(t: TestRun): string {
        return (t.description === "" || t.description === undefined) ? "-" : t.description;
    }

    static getStackTrace(t: TestRun): string {
        return t.testStackTrace === "" ? "-" : t.testStackTrace;
    }

    static getCategories(t: TestRun): string {
